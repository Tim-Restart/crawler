...
func TestGetURLsFromHTML(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Multiple URLS & Relative URLS",
			inputURL: "https://test.test.com",
			inputBody: `
			<html>
				<body>
					...
					<a href="/downloads/three">
						<span>Boot.dev</span>
					</a>
				</body>
			</html>
			`,
			expected: []string{"https://something.com", "https://spannerworks.net", "https://other.com/path/one", "https://test.test.com/images/two", "https://test.test.com/downloads/three"},
		},
